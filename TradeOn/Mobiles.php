...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="Mobiles.php">Mobiles</a></li>
...
$items = $form->posting("select ads.id as itemId, title, detail, country, City, type, Interestitem, image, ads.date, uId from ads left join favs on ads.id = favs.itemId WHERE type in ('Mobiles') order by itemId desc");    ?>
<div id="wrapper">
...
$form = new items();
$items = $form->loggedOut_posting("SELECT * FROM `ads` where type in ('Mobiles') order by id desc");	
}

//$items = $form->posting("SELECT * FROM `ads` WHERE type in ('Mobiles') order by id desc");
?>
</div></div></div>
</body>
</html>
