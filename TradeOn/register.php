...
<form class="form-horizontal" class="form_page" action="" method="post">
    <div class="form-group">
        ...
        <label class="col-md-3 control-label" for="username">Username:</label> <span><?php echo $validation->fieldError('username'); ?></span>
		<div class="col-md-9">
    ...
    <div class="form-group">
        <label class="col-md-3 control-label" for="password">Password:</label>  <span><?php echo $validation->fieldError('password'); ?></span>
		<div class="col-md-9">
    ...
    <div class="form-group">
        <label class="col-md-3 control-label" for="password_again">Retype Password:</label> <span><?php echo $validation->fieldError('password_again'); ?></span>
		<div class="col-md-9">
        <input class="form-control" type="password" name="password_again" id="password_again" value="" autocomplete="off"/> 
		</div>
    </div>
    <div class="form-group">
        <label  class="col-md-3 control-label" for="name">Name:</label>  <span><?php echo $validation->fieldError('name'); ?></span>
		<div class="col-md-9">
        <input class="form-control" type="text" name="name" id="name" value="<?php echo escape(Input::get('name')); ?>" autocomplete="off"/>
    </div>
</div>
 <div class="form-group">
        <label class="col-md-3 control-label" for="age">Age:</label>  <span><?php echo $validation->fieldError('age'); ?></span>
		<div class="col-md-9">
    ...
    <div class="form-group">
        <label class="col-md-3 control-label" for="email">Email:</label>  <span><?php echo $validation->fieldError('email'); ?></span>
		<div class="col-md-9">
