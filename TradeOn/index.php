...
$items = $form->posting("select ads.id as itemId, title, detail, country, City, type, Interestitem, image, ads.date, uId from ads left join favs on ads.id = favs.itemId order by itemId desc");
    ?>
<div id="wrapper">
...
$form = new items();
$items = $form->loggedOut_posting("SELECT * FROM `ads` order by id desc");	
