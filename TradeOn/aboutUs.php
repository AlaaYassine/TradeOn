...
<div class="container">
   ...
   <h1> TradeOn </h1><br>
	<h4> TradeOn makes it easier for people to trade since it eliminates the hassle of the payments and the fear of fraud. <br>The only way to get the item you are seeking is by giving away an item of yours. It is simple, fun and free.   </h4> 
    <br><h4>So sign up if you have not already and start trading!	</h4>
</div>
	</div>
</div>
</html>
